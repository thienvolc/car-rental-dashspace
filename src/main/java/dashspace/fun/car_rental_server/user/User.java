...
import dashspace.fun.car_rental_server.session.Session;
import dashspace.fun.car_rental_server.location.Location;
import dashspace.fun.car_rental_server.notification.Notification;
import dashspace.fun.car_rental_server.rental.Rental;
import dashspace.fun.car_rental_server.rental.RentalCancellation;
import dashspace.fun.car_rental_server.review.Review;
import dashspace.fun.car_rental_server.role.Role;
import dashspace.fun.car_rental_server.user.enums.Gender;
import dashspace.fun.car_rental_server.user.enums.UserStatus;
import dashspace.fun.car_rental_server.host_document.IdentityDocument;
...
import static dashspace.fun.car_rental_server.user.enums.UserStatus.*;
